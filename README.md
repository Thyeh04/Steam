...
Разработано для учебного проекта "Dota 2 TI 2021 Data Analysis"
с использованием Python и PostgreSQL.
Программа демонстрирует навыки работы с:

SQL-запросами и агрегатами

Визуализацией данных

Интерактивными графиками

Автоматизацией аналитических отчётов

✅ Лицензия

Этот проект предоставлен для учебных и исследовательских целей.
Свободно используйте и модифицируйте с указанием автора.
